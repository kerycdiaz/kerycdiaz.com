...
export const setNavigatorPosition = navigatorPosition => ({
    type: SET_NAVIGATOR_POSITION, navigatorPosition
})

export const setNavigatorShape = navigatorShape => ({
    type: SET_NAVIGATOR_SHAPE, navigatorShape
})

export const setNavigatorFilter = navigatorFilter => ({
    type: SET_NAVIGATOR_FILTER, navigatorFilter
})

export const setIsWideScreen = isWideScreen => ({
    type: SET_IS_WIDE_SCREEN, isWideScreen
})

export const setScrollToTop = scrollToTop => ({
    type: SET_SCROLL_TO_TOP, scrollToTop
})

export const setFontSizeIncrease = fontSizeIncrease => ({
    type: SET_FONT_SIZE_INCREASE, fontSizeIncrease
})

export const setCategoryFilter = categoryFilter => ({
    type: SET_CATEGORY_FILTER, categoryFilter
})
